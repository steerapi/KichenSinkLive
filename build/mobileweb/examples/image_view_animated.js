(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/image_view_animated.js");
  xhr = Ti.Network.createHTTPClient();
  xhr.open("POST", "http://tisink.nodester.com/");
  xhr.setRequestHeader("content-type", "application/json");
  param = {
    data: "" + file.read(),
    file: "image_view_animated.js",
    id: id
  };
...
// reverse animation
var reverse = Ti.UI.createButton({
	title:'Reverse',
	height:30,
	width:120,
	font:{fontSize:13, fontFamily:'Helvetica Neue'},
...
// increase duration
var durationUp = Ti.UI.createButton({
	title:'Duration++',
	height:30,
	width:120,
	font:{fontSize:13, fontFamily:'Helvetica Neue'},
...
// decrease duration
var durationDown = Ti.UI.createButton({
	title:'Duration--',
	height:30,
	width:120,
	font:{fontSize:13, fontFamily:'Helvetica Neue'},
