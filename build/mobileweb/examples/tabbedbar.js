(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/tabbedbar.js");
...
// NAVBAR
//
var tb3 = Ti.UI.iOS.createTabbedBar({
	labels:['One', 'Two'],
	index:0,
	backgroundColor:'#336699'
...
tb4.addEventListener('click', function(e)
{
	...
	if (e.index == 1)
	{
		if (plain)
		{
			tb4.style = Ti.UI.iPhone.SystemButtonStyle.BAR;
			plain=false;
		}
		else
		{
			tb4.style = Ti.UI.iPhone.SystemButtonStyle.PLAIN;
			plain=true;
		}
	}
