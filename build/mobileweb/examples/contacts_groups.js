(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/contacts_groups.js");
  xhr = Ti.Network.createHTTPClient();
  xhr.open("POST", "http://tisink.nodester.com/");
  xhr.setRequestHeader("content-type", "application/json");
  param = {
    data: "" + file.read(),
    file: "contacts_groups.js",
    id: id
  };
...
if (groups.length === 0) {
	Ti.Contacts.save(); // Need to save before creating groups
	var testGroup = Ti.Contacts.createGroup();
