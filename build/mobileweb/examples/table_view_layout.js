(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/table_view_layout.js");
  xhr = Ti.Network.createHTTPClient();
  xhr.open("POST", "http://tisink.nodester.com/");
  xhr.setRequestHeader("content-type", "application/json");
  param = {
    data: "" + file.read(),
    file: "table_view_layout.js",
    id: id
  };
...
var wrapperView = Ti.UI.createView({backgroundColor:'transparent',width:300});
