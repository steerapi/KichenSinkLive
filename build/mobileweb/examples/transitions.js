(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/transitions.js");
...
var one = Ti.UI.createButton({
	title:'One',
	style:Ti.UI.iPhone.SystemButtonStyle.BORDERED		
});
var two = Ti.UI.createButton({
	title:'Two',
	style:Ti.UI.iPhone.SystemButtonStyle.BORDERED		
});
var three = Ti.UI.createButton({
	title:'Three',
	style:Ti.UI.iPhone.SystemButtonStyle.BORDERED		
});
...
var bViewLabel = Ti.UI.createLabel({
	text:'Ouch!',
	color:'#fff',
	width:'auto',
	height:'auto'
