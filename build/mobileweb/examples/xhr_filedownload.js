(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/xhr_filedownload.js");
  xhr = Ti.Network.createHTTPClient();
  xhr.open("POST", "http://tisink.nodester.com/");
  xhr.setRequestHeader("content-type", "application/json");
  param = {
    data: "" + file.read(),
    file: "xhr_filedownload.js",
    id: id
  };
...
b1.addEventListener('click', function()
{
	...
	c.onload = function()
	{
		...
		var filename = Ti.Platform.name == 'android' ? 'test.png' : 'test.pdf';
	...
	if (Ti.Platform.name == 'android') {
		...
		c.file = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,'test.pdf');
	}
...
var largeFile = Ti.UI.createButton({
