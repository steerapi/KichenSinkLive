(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/rss.js");
...
function displayItems(itemList){
	...
	Ti.UI.currentWindow.add(feedTableView);
...
function loadRSSFeed(url){
	...
	xhr.onload = function()
	{
		...
		Ti.UI.currentWindow.title = feedTitle;
...
Ti.UI.currentWindow.setRightNavButton(r);
