(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/textfield_therest.js");
  xhr = Ti.Network.createHTTPClient();
  xhr.open("POST", "http://tisink.nodester.com/");
  xhr.setRequestHeader("content-type", "application/json");
  param = {
    data: "" + file.read(),
    file: "textfield_therest.js",
    id: id
  };
...
b2.addEventListener('click', function()
{
	switch (bgi) {
		...
		case 2:
			...
			tf1.borderStyle = Ti.UI.INPUT_BORDERSTYLE_ROUNDED;
			bgi=0;
			break;
	}
...
tf1.autocapitalization = Ti.UI.TEXT_AUTOCAPITALIZATION_NONE;
...
b6.addEventListener('click', function()
{
	...
	switch (auto)
	{
		case 0:
			...
			break;
		case 1:
			tf1.autocapitalization = Ti.UI.TEXT_AUTOCAPITALIZATION_WORDS;
			b6.title = 'Capital (words)';
			auto++;
			break;
		case 2:
			tf1.autocapitalization = Ti.UI.TEXT_AUTOCAPITALIZATION_SENTENCES;
			b6.title = 'Capital (sent.)';
			auto++;
			break;
		case 3:
			tf1.autocapitalization = Ti.UI.TEXT_AUTOCAPITALIZATION_ALL;
...
b7.addEventListener('click', function()
{
	...
	{
		case 0:
			tf1.clearButtonMode = Ti.UI.INPUT_BUTTONMODE_ALWAYS;
			b7.title = 'Clear Button (A)';
			clear++;
			break;
		case 1:
			b7.title = 'Clear Button (N)';
			tf1.clearButtonMode = Ti.UI.INPUT_BUTTONMODE_NEVER;
			clear++;
			break;
		case 2:
			b7.title = 'Clear Button (F)';
			tf1.clearButtonMode = Ti.UI.INPUT_BUTTONMODE_ONFOCUS;
			clear++;
			break;
		case 3:
			b7.title = 'Clear Button (B)';
			tf1.clearButtonMode = Ti.UI.INPUT_BUTTONMODE_ONBLUR;
			clear=0;
			break;
	}
});
