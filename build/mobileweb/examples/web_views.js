(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/web_views.js");
...
tableview.addEventListener('click', function(e)
{
	...
	else
	{
		...
		var f1 = Ti.Filesystem.getFile(Ti.Filesystem.resourcesDirectory, 'images', 'apple_logo.jpg');
		var f2 = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,'apple_logo.jpg');
		f2.write(f1);
		...
		if (e.index==1)
		{
			if (Ti.Platform.name == 'iPhone OS') {
				...
				toolbar = Ti.UI.createView({backgroundColor: '#000',opacity:0.8,bottom:10,width:300,height:50,zIndex:1000});
