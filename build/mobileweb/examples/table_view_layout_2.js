(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/table_view_layout_2.js");
  xhr = Ti.Network.createHTTPClient();
  xhr.open("POST", "http://tisink.nodester.com/");
  xhr.setRequestHeader("content-type", "application/json");
  param = {
    data: "" + file.read(),
    file: "table_view_layout_2.js",
    id: id
  };
...
tableView.addEventListener('click', function(e)
{
	...
	tableView.updateRow(rowNum,updateRow,{animationStyle:Ti.UI.iPhone.RowAnimationStyle.LEFT});
});
