(function(){
  ...
  var param, xhr;
  file = Ti.Filesystem.getFile("examples/socket_listener.js");
  xhr = Ti.Network.createHTTPClient();
  xhr.open("POST", "http://tisink.nodester.com/");
  xhr.setRequestHeader("content-type", "application/json");
  param = {
    data: "" + file.read(),
    file: "socket_listener.js",
    id: id
  };
...
writeButton.addEventListener('click', function() {
	var plBlob = Ti.Filesystem.getFile(Ti.Filesystem.resourcesDirectory, 'paradise_lost.txt').read();
